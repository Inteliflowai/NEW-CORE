...
**NEXT:** gradebook **dates + trend** ([[v2-gradebook-dates-and-trend]] — per-day columns + per-student trend + Barb's grade-cell hover showing assignment name + submitted date) → then **Epic 4 parent dashboard** OR a **Teacher Authoring / Content Studio** epic ([[v2-content-engine-and-authoring-gap]] — the engine + student side are built; teacher upload/library/generate-trigger UI is stub) — Marvin to sequence.
