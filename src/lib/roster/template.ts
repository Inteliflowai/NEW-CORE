...
export function buildRosterTemplate(): Uint8Array {
  ...
  XLSX.utils.book_append_sheet(
    ...
    makeSheet(
      ...
      [
        ['Ms. Jane Smith',    'jsmith@school.edu',    'Core2026!'],
        ['Mr. Carlos Rivera', 'crivera@school.edu',   'Core2026!'],
      ],
    ),
    SHEET_TEACHERS,
  );
  ...
  XLSX.utils.book_append_sheet(
    ...
    makeSheet(
      ...
      [
        ['Math 8A',    'Mathematics',             'Grade 8', 'Period 1', 'jsmith@school.edu'],
        ['Math 8B',    'Mathematics',             'Grade 8', 'Period 2', 'jsmith@school.edu'],
        ['English 9',  'English Language Arts',   'Grade 9', 'Period 1', 'crivera@school.edu'],
      ],
    ),
    SHEET_CLASSES,
  );
  ...
  XLSX.utils.book_append_sheet(
    ...
    makeSheet(
      ...
      [
        ['Luis Garcia',    'lgarcia@student.school.edu',  'Student2026!', 'Grade 8'],
        ['Maria Santos',   'msantos@student.school.edu',  'Student2026!', 'Grade 8'],
        ['James Chen',     'jchen@student.school.edu',    'Student2026!', 'Grade 9'],
        ['Olivia Wilson',  'owilson@student.school.edu',  'Student2026!', 'Grade 9'],
      ],
    ),
    SHEET_STUDENTS,
  );
  ...
  XLSX.utils.book_append_sheet(
    ...
    makeSheet(
      ...
      [
        ['lgarcia@student.school.edu',  'Math 8A',    'Period 1', 'jsmith@school.edu'],
        ['msantos@student.school.edu',  'Math 8A',    'Period 1', 'jsmith@school.edu'],
        ['jchen@student.school.edu',    'Math 8B',    'Period 2', 'jsmith@school.edu'],
        ['owilson@student.school.edu',  'English 9',  'Period 1', 'crivera@school.edu'],
        ['lgarcia@student.school.edu',  'English 9',  'Period 1', 'crivera@school.edu'],
      ],
    ),
    SHEET_ENROLLMENTS,
  );
  ...
  XLSX.utils.book_append_sheet(
    ...
    makeSheet(
      ...
      [
        ['Robert Garcia',  'rgarcia@email.com',  'Core2026!', 'lgarcia@student.school.edu'],
        ['Elena Santos',   'esantos@email.com',  'Core2026!', 'msantos@student.school.edu'],
        ['David Chen',     'dchen@email.com',    'Core2026!', 'jchen@student.school.edu'],
        ['Sarah Wilson',   'swilson@email.com',  'Core2026!', 'owilson@student.school.edu'],
        // Same parent linked to a second student — demonstrates one-parent-many-students
        ['Robert Garcia',  'rgarcia@email.com',  'Core2026!', 'msantos@student.school.edu'],
      ],
    ),
    SHEET_PARENTS,
  );
