...
const data: Gradebook = {
  ...
  cells: {
    s1: { 'due:d1': { attempt_id: 'h1', status: 'graded', displayed_grade: 88, score_pct: 88, effort_label: null, is_override: false, submitted_on_time: true, allow_redo: false } },
    s2: { 'due:d1': { attempt_id: null, status: 'missing', displayed_grade: null, score_pct: null, effort_label: null, is_override: false, submitted_on_time: null, allow_redo: false } },
  },
...
describe('GradebookGrid', () => {
  ...
  it('shows an override marker on an overridden cell', () => {
    render(<GradebookGrid data={oneCell({ attempt_id: 'h1', status: 'graded', displayed_grade: 90, score_pct: 70, effort_label: null, is_override: true, submitted_on_time: true, allow_redo: false })} />);
  ...
  it('shows a "late" badge when submitted_on_time is false', () => {
    render(<GradebookGrid data={oneCell({ attempt_id: 'h1', status: 'graded', displayed_grade: 80, score_pct: 80, effort_label: null, is_override: false, submitted_on_time: false, allow_redo: false })} />);
  ...
  it('renders the redo glyph and the retained prior grade for redo_in_progress', () => {
    render(<GradebookGrid data={oneCell({ attempt_id: 'h1', status: 'redo_in_progress', displayed_grade: 80, score_pct: 80, effort_label: null, is_override: false, submitted_on_time: true, allow_redo: false })} />);
