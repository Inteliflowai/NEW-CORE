...
export function ReadPhase({ content, onStart }: ReadPhaseProps) {
  ...
  return (
    <div className="min-h-screen bg-bg flex flex-col items-center px-4 py-8">
      <Card tone="brand" className="max-w-2xl w-full flex flex-col gap-5 p-6">
        ...
        {passage && (
          <div className="rounded-lg border-2 border-surface bg-surface px-5 py-4 text-fg text-sm leading-relaxed">
